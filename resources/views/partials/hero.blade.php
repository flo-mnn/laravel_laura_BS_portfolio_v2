...
<section id="hero" style="background-image: url('storage/img/{{$page_images[0]->src}}');">
    <div class="hero-container">
      ...
      @if (Str::contains((Route::getCurrentRoute()->uri()),'bo'))
          {{-- display nothing --}}
          @else
          <a href="#about" class="btn-scroll scrollto" title="Scroll Down" onmouseover="this.style.color='var(--{{$color->color}})';" onmouseout="this.style.color=`var(--light)`;"><i class="bx bx-chevron-down"></i></a>
      @endif
    </div>
  </section><!-- End Hero -->
